...
\begin{proof}[Resolução]
    ...
    \begin{equation*}
        ...
        \vetor{J}_P = \frac{\chi_e \epsilon_0 I}{\epsilon\pi a^2}\vetor{e}_z \implies \vetor{J} = \frac{(\chi_m \epsilon + \chi_e \epsilon_0)I}{\epsilon \pi a^2}\vetor{e}_z% = \frac{(\chi_m + \chi_e + \chi_m \chi_e)I}{\pi a^2}\vetor{e}_z
    \end{equation*}
